...
//Inserts a new node into the BST by ID order
...
// Prints the price search results
...
// Frees the memory for the price search results
...
// Sorts the price search results in ascending or descending order
